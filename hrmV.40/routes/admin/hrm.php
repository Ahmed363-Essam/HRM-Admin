...
Route::group(['prefix' => 'hrm', 'middleware' => ['xss', 'admin', 'MaintenanceMode']], function () {
    ...
    Route::group(['prefix' => 'attendance'], function () {
        ...
        Route::get('/exc', [AttendanceController::class, 'exceldata'])->name('attendance.exceldata')->middleware('PermissionCheck:attendance_read');
        ...
        Route::get('/exportAttendencesExcel', [AttendanceController::class, 'export'])->name('exportAttendencesExcel');
    });
    //attendance end
    //designation start
